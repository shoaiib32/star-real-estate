      ...
      <div className="max-w-7xl mx-auto md:flex md:flex-row-reverse md:items-center">
        ...
        <div className="md:w-1/2 md:pl-8">
          <div className="text-center md:text-left">
           ...
           Welcome to Star Paradise, a premium collection of 23 luxurious residences located in the prime location of Nalasopara West, Yashwant Gaurav. Designed for modern living, this exclusive project combines comfort, elegance, and convenience. Developed by a well-reputed builder with a strong track record of successful projects, Star Paradise offers the perfect opportunity to own your dream home in a fast-growing neighborhood.
            </p>
