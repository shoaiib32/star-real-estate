      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        <div className="hover:shadow-md hover:shadow-[#040c16]">
          <div className="bg-white rounded-lg shadow-lg">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRvtMuglDuj6rBu_crS63RXq59ocZ757wsdA&s" alt="Property" className="w-full max-h-64 object-cover rounded-t-lg h-1/3 md:h-64" />
        ...
        <div className="hover:shadow-md hover:shadow-[#040c16]">
          <div className="bg-white rounded-lg shadow-lg">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-5RbszmrVtvQ_C9yEB_xcckxYyDO_2CU0Vg&s" alt="Property" className="w-full max-h-64 object-cover rounded-t-lg h-1/3 md:h-64" />
            <div className="py-6 px-4">
        ...
        <div className="hover:shadow-md hover:shadow-[#040c16]">
          <div className="bg-white rounded-lg shadow-lg">
            <img src="https://www.raysonsconstructions.com/krystal-tower/krystal-tower-nagala-park-kolhapur-07.jpg" alt="Property" className="w-full max-h-64 object-cover rounded-t-lg h-1/3 md:h-64" />
            <div className="py-6 px-4">
